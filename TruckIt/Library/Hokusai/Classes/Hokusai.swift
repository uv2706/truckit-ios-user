...
public enum HOKColorScheme {
    ...
    func getColors() -> HOKColors {
        ...
        case .asagi:
            ...
            return HOKColors(
                backGroundColor: #colorLiteral(red: 0.03921568627, green: 0.09411764706, blue: 0.3450980392, alpha: 1),
                buttonColor: #colorLiteral(red: 0.1411764706, green: 0.2901960784, blue: 0.6078431373, alpha: 1),
                cancelButtonColor: #colorLiteral(red: 0, green: 0.4784313725, blue: 1, alpha: 1),
        ...
        case .enshu:
            return HOKColors(
                backGroundColor: #colorLiteral(red: 0.003921568627, green: 0.7058823529, blue: 1, alpha: 1),
                buttonColor: #colorLiteral(red: 0.003921568627, green: 0.7058823529, blue: 1, alpha: 1),
                cancelButtonColor: #colorLiteral(red: 0.003921568627, green: 0.7058823529, blue: 1, alpha: 1),
                fontColor: #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
            )
        default: // Hokusai
            return HOKColors(
...
final public class Hokusai: UIViewController, UIGestureRecognizerDelegate {
    ...
    required public init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(Hokusai.onOrientationChange(_:)), name: UIApplication.didChangeStatusBarFrameNotification, object: nil)
    }
